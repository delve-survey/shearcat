...
python -u utils/Bmode.py --Name DECADE --Output /scratch/midway2/dhayaa/TEMP/ --njobs 4 --Nrands 100 --DECADE

#python -u utils/Bmode.py --Name DES --Output /scratch/midway2/dhayaa/TEMP/ --njobs 4 --Nrands 50 --DES
