...
for i in range(nchunk):
    ...
    RES = juan_dnf.dnf( training_data[train_mask, :m.shape[1]][inds_train][s], training_data[train_mask, -1][inds_train][s], 
...
if rank == 0:
    with h5py.File(f'/scratch/midway3/dhayaa/DECADE_DR3_DNF_{name}_validation.hdf', 'w') as f:
...
if rank == 0:
    with h5py.File(f'/project/chihway/data/decade/dnf/DECADE_DR3_DNF_{name}.hdf', 'w') as f:
